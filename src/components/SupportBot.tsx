  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 z-40 rounded-full shadow-lg bg-gradient-to-br from-amber-500 to-amber-600 text-white p-4 hover:scale-[1.03] transition"
      ...
      {open && (
        <div
          className="fixed bottom-6 right-6 z-50 w-[360px] max-w-[92vw] max-h-[75vh] overflow-y-auto"
